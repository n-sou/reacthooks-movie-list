...
const MovieInfo = styled.span`
  padding-left: 12px;
`
export const MovieItem = memo(({ movieImg, movieName, voteCount, movieRate }: { movieImg: string, movieName: string, voteCount: number, movieRate: number }) => {
    ...
    return (
        <CardWrap ref={cardDom} onMouseMove={handleMouseMove} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
